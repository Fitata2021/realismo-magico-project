...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const images = [imglorca14, imgRoh, imgAncestral];
        ...
        <>
          ...
          <section className="description">
            ...
            <p>
              ...
              por la combinación de elementos realistas y fantásticos,
              desafiando las convenciones tradicionales. A pesar de una
              persistente controversia en torno a conceptos y definiciones, en
              Latinoamérica es comúnmente relacionado con el concepto de "lo
              real maravilloso" del escritor cubano Alejo Carpentier.
            </p>

            <p>
              Respecto al campo literario, entre las obras más emblemáticas del
              realismo mágico destaca sin duda "Cien años de soledad" del
              escritor colombiano Gabriel García Márquez. En esta novela, se
              crea un mundo donde lo mágico y lo real se entrelazan de manera
              extraordinaria. Personajes que viven más de cien años, lluvias
              interminables, objetos que levitan y otros fenómenos inexplicables
              dan forma a un relato cautivador que atrapa al lector desde la
              primera página.
            </p>
            <p>
              ...
              formas de expresión artística como las artes plásticas. En
              particular, en el campo de la pintura, han sido diferentes
              artistas los que han utilizado elementos mágicos y oníricos en sus
              obras, desafiando la realidad y creando imágenes sorprendentes que
              desconciertan y fascinan al espectador.
            </p>
            <img className="lorca-painting" src={imglorca14} alt="" />
            <p className="subparagraph">
              <i>
                "La Cacería de la Sirena", Guillermo Lorca Garcia, Oleo sobre
                Lienzo
              </i>
            </p>
            <br />
            ...
            <p>
              El realismo mágico es un intento de capturar la esencia de la
              realidad a través de la mezcla de lo ordinario y lo
              extraordinario. En lugar de presentar un mundo puramente
              fantástico o completamente realista, los escritores y artistas que
              utilizan este estilo buscan mostrar una realidad ampliada, llena
              de posibilidades inexploradas y misterios ocultos.
            </p>
            <p>
            ...
            <p>
              El realismo mágico invita al espectador a cuestionar los límites
              de la realidad y a sumergirse en un mundo donde lo imposible se
              vuelve posible. A través de la combinación de lo cotidiano y lo
              fantástico, se crea una atmósfera única que captura la atención y
              la imaginación del lector o espectador.
            </p>
            <p>
            ...
            <p>
              El alemán crítico de arte Franz Roh (1890-1965), introdujo el
              término "realismo mágico" en 1925 para definir una nueva fase del
              arte que surgía después del expresionismo. En su libro "Nach
              Expressionismus: Magischer Realismus", Roh se dedicó a clasificar
              y comprender esta fase desconocida del arte contemporáneo.
            </p>
            ...
            <br />
            <p>
              Roh reconoció la dificultad de ser un "historiador del presente",
              ya que la perspectiva contemporánea a menudo no logra apreciar
              completamente los cambios y desarrollos artísticos. Sin embargo,
              él vio el realismo mágico como un cambio tan esencial como el
              ocurrido entre el impresionismo y el expresionismo.
            </p>
            <p>
              Hoy en día, el término "realismo mágico" está estrechamente
              asociado con la literatura hispanoamericana, aunque inicialmente
              se utilizó para describir un movimiento artístico en la pintura
              europea.
            </p>
            <p>
              En términos de arte, el realismo mágico se distingue por su
              retorno a la objetividad y la representación de la realidad de una
              manera nueva y sorprendente. A diferencia del expresionismo, que a
              menudo se centraba en los efectos emocionales, el realismo mágico
              busca capturar la integridad seductora de los objetos y la magia
              inherente a la existencia.
            </p>
            <p>
              Los artistas de esta corriente no se limitan a copiar la
              naturaleza, sino que construyen un mundo nuevo a través de su
              obra, explorando la relación entre lo familiar y lo misterioso que
              yace detrás de la representación. Esto no es un retroceso, sino
              una apertura a nuevas posibilidades creativas.
            </p>
            <p>
              En resumen, Franz Roh acuñó el término "realismo mágico" para
              describir una nueva fase del arte que se alejaba del expresionismo
              y abrazaba una forma de objetividad en la representación de la
              realidad, resaltando la magia que subyace en el mundo que nos
              rodea.
            </p>
            ...
            <p>
              ...
              ¡Bienvenido a un viaje encantador a través de la magia y la
